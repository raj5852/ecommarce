<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#product-ui" aria-expanded="false" aria-controls="product-ui">
          <i class="mdi mdi-circle-outline menu-icon"></i>
        ...
        <div class="collapse" id="product-ui">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ url('') }}">Add product</a></li>
