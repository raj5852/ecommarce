...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AfTa9zNmB9GGGgAObBT3-2PaA5CJWxvNN95iBSL6pHmPZ7IGpOxxTtSHiOkdmHvLwsppmC1B3ri90xyq&currency=USD">
    </script>
        ...
        paypal.Buttons({
                ...
                return actions.order.create({
                    ...
                    purchase_units: [{
                        ...
                        amount: {
                            ...
                            value: "{{ $totalProductAmount }}" // Can also reference a variable or function
            ...
            onApprove: (data, actions) => {
                ...
                return actions.order.capture().then(function(orderData) {
                    ...
                    Livewire.emit('transitionEmit',transaction.id );
